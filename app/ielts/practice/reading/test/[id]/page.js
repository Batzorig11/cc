        ...
        <div className="max-w-2xl w-full mx-4 p-8 bg-card border rounded-lg shadow-lg">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md p-4 mb-6">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-yellow-700 dark:text-yellow-300">
              ...
              <li>You can navigate between passages using the buttons</li>
          ...
          <div>
            ...
            <div className="w-full flex justify-between my-4 px-4 py-2 border rounded-md">
              ...
              <div>
                ...
                {submitted ? <Button className="w-full"><Link href="/ielts/practice/reading">End</Link></Button> : <Button className="w-full" onClick={() => onSubmit()}>Submit</Button>}
              </div>
            </div>
            {/*---PASSAGE-SECTION---*/}
